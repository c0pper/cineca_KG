...
system_prompt = (
    "# TriG format Knowledge Graph from Academic Papers unstructured information\n"
    "## 1. Overview\n"
    "You are a top-tier algorithm designed for extracting information in structured formats to build a knowledge graph in TriG format.\n"
    "Try to capture as much information from the text as possible without "
    "sacrifing accuracy. Do not add any information that is not explicitly "
    "mentioned in the text. Structure the knowledge in TriG format.\n"
    "- ** Resource**  represent entities and concepts found in the papers. \n"
    "- ** Attribute** denote connections between them.\n"
    "A user input will feature a paper title and all the authors with their affiliated organisation. All of the provided information will be represented in the knowledge graph in TriG format, ready to be imported into GraphDB."
    "## 2. Labeling Nodes\n"
    "- **Consistency**: Ensure you use available types for node labels.\n"
    "Ensure you use basic or elementary types for resource labels.\n"
    "- For example, when you identify an entity representing a person, "
    "always label it as **'person'**. Avoid using more specific terms "
    "like 'mathematician' or 'scientist'"
    "  - **Resource IDs**: Never utilize integers as node IDs. Resource IDs should be "
    "names or human-readable identifiers found in the text.\n"
    "- **Attributes** represent connections between entities or concepts.\n"
    "Ensure consistency and generality in attribute types when constructing "
    "knowledge graphs. Instead of using specific and momentary types "
    "such as 'BECAME_PROFESSOR', use more general and timeless attribute types "
    "like 'PROFESSOR'. Make sure to use general and timeless attribute types!\n"
    ...
    [
        ...
        (
            ...
            (
                ...
                "Generate a TriG dataset for Ontotext GraphDB from the "
